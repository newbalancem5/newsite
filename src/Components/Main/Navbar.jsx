...
class NavigationBar extends Component {
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    ...
    <Nav.Link href="/PhotoGalery" > <Link to="/PhotoGalery" className="navitem"  >Галерея</Link></Nav.Link>
              <Nav.Link href="/Price"><Link to="/Price" className="navitem"> Стоимость работ </Link></Nav.Link>
    </Nav>
    <Nav>
